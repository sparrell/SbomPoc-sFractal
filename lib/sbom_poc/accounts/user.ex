defmodule SbomPoc.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, SbomPoc.Repo)
  ...
  """
  def valid_password?(%SbomPoc.Accounts.User{hashed_password: hashed_password}, password)
