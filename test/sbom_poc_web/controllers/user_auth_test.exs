defmodule SbomPocWeb.UserAuthTest do
  use SbomPocWeb.ConnCase, async: true

  alias SbomPoc.Accounts
  alias SbomPocWeb.UserAuth
  import SbomPoc.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SbomPocWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SbomPocWeb.Endpoint.subscribe(live_socket_id)
